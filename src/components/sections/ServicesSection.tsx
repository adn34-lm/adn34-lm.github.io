...
export default function ServicesSection() {
  return (
    <section id="servicios" className="bg-dark-900">
      <Card className="w-full min-h-screen bg-black/[0.96] relative overflow-hidden border-gold-900/30 border-x-0 rounded-none">
        ...
        <Reveal>
          <div className="text-center pt-16 md:pt-24 pb-6 md:pb-8 max-w-7xl mx-auto px-4 sm:px-8 lg:px-12 relative z-10">
            ...
            <div className="w-20 md:w-32 h-0.5 md:h-1 bg-gold-500 mx-auto" />
          </div>
        </Reveal>
          ...
          <div className="md:flex-[1.2] px-4 py-4 md:p-16 flex flex-col justify-center gap-4 md:gap-8">
            {services.map((service, i) => (
              <Reveal key={service.title} delay={i * 0.15}>
                <div className="group flex items-start gap-4 md:gap-6 p-4 md:p-8 rounded-xl md:rounded-2xl bg-dark-900/60 backdrop-blur-sm hover:bg-dark-900/80 transition-all duration-300 border border-gold-900/30 hover:border-gold-500/30">
                  <div className="w-12 h-12 md:w-16 md:h-16 rounded-xl md:rounded-2xl bg-gold-500/10 flex items-center justify-center shrink-0 group-hover:bg-gold-500/20 transition-colors">
                    <service.icon className="w-6 h-6 md:w-8 md:h-8 text-gold-400" />
                  </div>
                  <div>
